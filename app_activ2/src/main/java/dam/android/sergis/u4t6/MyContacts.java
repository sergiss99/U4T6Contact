    ...
    private ArrayList<ContactItem> getContacts() {
        ...
        if (contactsCursor != null) {
            ...
            while (contactsCursor.moveToNext()) {
                ...
                //TODO Ex2: segun el numero de tipo, establecemos la String del Tipo
                if (contactsCursor.getString(type).equals("1")) {
                    typeNumber = "HOME";
                } else if (contactsCursor.getString(type).equals("2")) {
                    typeNumber = "MOBILE";

                } else if (contactsCursor.getString(type).equals("3")) {
                    typeNumber = "WORK";
